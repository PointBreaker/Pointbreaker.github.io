(() => {
  ...
  Promise.all([fetch('course-info.json').then(r=>r.json()),fetch('api/status.json').then(r=>r.json())]).then(([info,status])=>{
    ...
    root.innerHTML=`<div class="reader-course-hero"><div><p class="muted"><a href="../../">全部课程</a> / CS 168</p><h1>CS 168：互联网导论</h1><p class="reader-lede">一个数据包如何从应用出发，经过一系列局部决策抵达远端？没有中央控制的互联网，又如何保持互联？</p><p class="muted">加州大学伯克利分校 · 2026 年秋季 · ${lectures.length} 讲<br>教师：${esc(info.instructors.join('、'))} · <a href="${esc(info.sourceUrl)}">官方课程</a></p></div><aside class="reader-course-question" aria-label="课程核心问题"><span>核心问题</span><h2>沿一个 packet，看见互联网怎样保持互联。</h2><p>每一阶段都只追踪当下可见的 header、局部 state 与下一次 event。</p><ol><li><b>01</b>分层与寻址</li><li><b>02</b>路由与转发</li><li><b>03</b>传输与故障</li></ol></aside></div>
